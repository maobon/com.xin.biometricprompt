...
public class CertificateRevocationStatus {
    ...
    private static final String TAG = "CERT_REVOKE_STATUS";
    ...
    public static CertificateRevocationStatus loadStatusFromFile(BigInteger serialNumber, String filePath) throws IOException {
        return loadStatusFromFile(serialNumber.toString(16), filePath);
    }

    public static CertificateRevocationStatus loadStatusFromFile(String serialNumber, String filePath) throws IOException {
    ...
    public static CertificateRevocationStatus fetchStatus(String serialNumber) throws IOException {
        ...
        BufferedReader reader = new BufferedReader(statusListReader);
        String line = null;
        while ((line = reader.readLine()) != null) {
            sb.append(line);
        }
        Log.wtf(TAG, "google att cert revoke status resp:" + sb.toString());
